...
// module so the same code runs unmodified in proxy.ts (Edge runtime),
...
/** Verifies a session token's signature and expiry. Safe to call from proxy.ts (Edge runtime). */

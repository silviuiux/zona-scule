 ...
 *   (pachetul "ws" e necesar doar pe Node < 22 — @supabase/supabase-js
 *   inițializează un RealtimeClient la createClient() chiar dacă scriptul
 *   nu-l folosește, și Node 20 nu are WebSocket nativ)
 *
 * Usage:
...
// { realtime: { transport: ws } } — scriptul nu folosește realtime deloc, dar
// SupabaseClient inițializează un RealtimeClient în constructor indiferent,
// iar pe Node < 22 (fără WebSocket nativ) asta aruncă altfel o eroare fatală.

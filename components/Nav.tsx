    ...
    <>
      ...
      <nav className={`nav${scrolled ? ' scrolled' : ''}`}>
        ...
        <form className="nav-search-form" onSubmit={handleSearch}>
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="rgba(0,0,0,0.35)" strokeWidth="2" style={{ flexShrink: 0 }}>
        ...
        {/* Search icon trigger */}
        <button className="nav-search-btn" type="button" onClick={() => inputRef.current?.focus()}>
